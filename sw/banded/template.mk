...
DEFINES += -DSEQ_LEN=$(seq-len) -DBAND_SIZE=$(band-size) -DNUM_SEQ=$(num-seq) -DCOL=$(col)
...
RISCV_CCPPFLAGS += -DSEQ_LEN=$(seq-len) -DBAND_SIZE=$(band-size) -DNUM_SEQ=$(num-seq) -DCOL=$(col)
