...
DEFINES += -DMAT_M=$(mat-m) -DMAT_N=$(mat-n) -DMAT_K=$(mat-k) -DBLK_K=$(blk-k) -DBLK_C=$(blk-c)
...
RISCV_CCPPFLAGS += -DMAT_M=$(mat-m) -DMAT_N=$(mat-n) -DMAT_K=$(mat-k) -DBLK_K=$(blk-k) -DBLK_C=$(blk-c)
