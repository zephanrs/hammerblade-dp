...
int nw_naive_multipod(int argc, char ** argv) {
  ...
  BSG_CUDA_CALL(hb_mc_device_init(&device, "nw_naive_multipod", HB_MC_DEVICE_ID));
  ...
  hb_mc_device_foreach_pod_id(&device, pod)
  {
    ...
    #define CUDA_ARGC 4
    uint32_t cuda_argv[CUDA_ARGC] = {d_query, d_ref, d_dp_matrix, pod};
...
declare_program_main("nw_naive_multipod", nw_naive_multipod);
